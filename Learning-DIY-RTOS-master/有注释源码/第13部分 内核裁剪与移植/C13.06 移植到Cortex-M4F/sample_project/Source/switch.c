...
void tTaskStackInit(tTask * task, void (*entry)(void *), void *param, uint32_t * stack, uint32_t size) {
    ...
    *(--stackTop) = (unsigned long)(0);                     // 空,未用
    *(--stackTop) = (unsigned long)(0);                     // FPSCR
    *(--stackTop) = (unsigned long)(0x15);                  // S15
    *(--stackTop) = (unsigned long)(0x14);                  // S14
    *(--stackTop) = (unsigned long)(0x13);                  // S13
    *(--stackTop) = (unsigned long)(0x12);                  // S12
    *(--stackTop) = (unsigned long)(0x11);                  // S11
    *(--stackTop) = (unsigned long)(0x10);                  // S10
    *(--stackTop) = (unsigned long)(0x9);                  // S9
    *(--stackTop) = (unsigned long)(0x8);                  // S8
    *(--stackTop) = (unsigned long)(0x7);                  // S7
    *(--stackTop) = (unsigned long)(0x6);                  // S6
    *(--stackTop) = (unsigned long)(0x5);                  // S5
    *(--stackTop) = (unsigned long)(0x4);                  // S4
    *(--stackTop) = (unsigned long)(0x3);                  // S3
    *(--stackTop) = (unsigned long)(0x2);                  // S2
    *(--stackTop) = (unsigned long)(0x1);                  // S1
    *(--stackTop) = (unsigned long)(0x0);                  // S0
    ...
    *(--stackTop) = (unsigned long)(0x31);                  // S31
    *(--stackTop) = (unsigned long)(0x30);                  // S30
    *(--stackTop) = (unsigned long)(0x29);                  // S29
    *(--stackTop) = (unsigned long)(0x28);                  // S28
    *(--stackTop) = (unsigned long)(0x27);                  // S27
    *(--stackTop) = (unsigned long)(0x26);                  // S26
    *(--stackTop) = (unsigned long)(0x25);                  // S25
    *(--stackTop) = (unsigned long)(0x24);                  // S24
    *(--stackTop) = (unsigned long)(0x23);                  // S23
    *(--stackTop) = (unsigned long)(0x22);                  // S22
    *(--stackTop) = (unsigned long)(0x21);                  // S21
    *(--stackTop) = (unsigned long)(0x20);                  // S20
    *(--stackTop) = (unsigned long)(0x19);                  // S19
    *(--stackTop) = (unsigned long)(0x18);                  // S18
    *(--stackTop) = (unsigned long)(0x17);                  // S17
    *(--stackTop) = (unsigned long)(0x16);                  // S16
